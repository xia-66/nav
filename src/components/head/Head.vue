<template>
  <div id="js-home-head" class="home-head" :class="{
      clear: !showGrossGlass && props.headBgConfig.clear,
      white: props.headBgConfig.white,
...
//       iconfontClass: 'iconfont icon-md-stats',
//       text: '更新日志',
//       url: store.$state.appConfig.article.changelog,
//       isArticle: true,
//     },
//     {
//       iconfontClass: 'iconfont icon-md-at',
//       text: '关于我们',
//       url: store.$state.appConfig.article.about,
//       isArticle: true,
//     },
//   ];
// },
